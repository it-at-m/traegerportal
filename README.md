...
- [kita-stammdaten-webcomponent](./kita-stammdaten-webcomponent): Webcomponent for displaying data of daycare centers and the logged in provider.

## Getting Started

### kita-stammdaten-webcomponent
